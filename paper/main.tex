...
\item \textbf{VLA application} (\S\ref{sec:vla}). A LIBERO policy warm-started from the retrofit beats matched pure-OFT at $2$B and $4$B; \reskip{} on top of the trained policy beats the no-skip backbone on the 4-suite mean.
